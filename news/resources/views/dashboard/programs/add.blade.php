          ...
          <div class="col-lg-10">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <form method="post" action="{{url('/program/store')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group row"><label class="col-lg-2 col-form-label"><strong>Program Name</strong></label>

                                    <div class="col-lg-4"><input type="text" placeholder="Enter News Title" class="form-control" name="name" required> 
                                    </div>
                                    <label class="col-lg-1 col-form-label"><strong> Slug</strong></label>

                                    <div class="col-lg-5"><input type="text" placeholder="Enter program Slug" class="form-control" name="slug" required> 
                                    </div>
                                </div>
